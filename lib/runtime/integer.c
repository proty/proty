...
Object* Integer_createProto() {
  ...
  Object_setSlot(proto, Symbol_get("+"), Function_new((FuncPtr)Integer_add));
  Object_setSlot(proto, Symbol_get("-"), Function_new((FuncPtr)Integer_sub));
  Object_setSlot(proto, Symbol_get("*"), Function_new((FuncPtr)Integer_mul));
  Object_setSlot(proto, Symbol_get("/"), Function_new((FuncPtr)Integer_div));
